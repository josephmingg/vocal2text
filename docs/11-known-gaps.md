...
| G7 | ~~FTS5 external-content tables key on rowid over a TEXT-PK table~~ **Fixed** — schema v2 (2026-08-26) adds the INTEGER PRIMARY KEY surrogate + FTS rebuild migration; `searchSurvivesVacuum` covers it | docs/03 §5 | Done |
